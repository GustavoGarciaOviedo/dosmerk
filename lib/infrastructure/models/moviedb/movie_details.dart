...
class MovieDetails {
    ...
    factory MovieDetails.fromJson(Map<String, dynamic> json) => MovieDetails(
        ...
        id: json["id"],
        imdbId: json["imdb_id"] != null && json["imdb_id"].toString().isNotEmpty ? json["imdb_id"]: null ,//modificado en pelicuals raras
...
class ProductionCompany {
    ...
    factory ProductionCompany.fromMap(Map<String, dynamic> json) => ProductionCompany(
        id: json["id"],
        logoPath: json["logo_path"] as String? ?? "",//si no lo encuentra vuelve una cadena vacia
        name: json["name"],
